...
using Android.Views;
using BaseMvvm.Droid.Renderers;
...
namespace BaseMvvm.Droid.Renderers
{
    /// <summary>
        ...
        SwipeRefreshLayout.IOnRefreshListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PullToRefreshLayoutRenderer" /> class. 
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="PullToRefreshLayoutRenderer" />
        /// is refreshing.
        /// </summary>
        /// <value>
        /// <c> true </c> if refreshing; otherwise, <c> false </c>. 
        /// </value>
        ...
        /// <summary>
        /// Determines whether this instance can child scroll up. We do this since the actual swipe
        /// refresh can't figure it out
        /// </summary>
        /// <returns>
        /// <c> true </c> if this instance can child scroll up; otherwise, <c> false </c>. 
        /// </returns>
